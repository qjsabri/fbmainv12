      ...
      <div className="space-y-4">
        ...
        <div className="flex flex-col sm:flex-row gap-2 items-center justify-between">
          ...
          <div className="flex items-center gap-1 sm:gap-2 w-full sm:w-auto justify-end">
            <Button 
              size="sm" 
              className="text-xs h-8 px-2 sm:px-3 dark:border-gray-700 dark:text-gray-300"
          ...
          {isLoading && posts.length === 0 ? (
            ...
            <div className="bg-white rounded-lg shadow-sm card-responsive text-center dark:bg-gray-800">
              <div className="p-6">
                ...
                <Button 
                  onClick={handleRefresh} 
                  className="bg-blue-600 hover:bg-blue-700 text-white shadow-md text-sm py-1 px-3"
